import { _decorator, Component, Sprite, SpriteFrame, Texture2D, ImageAsset, UITransform, CCString } from "cc";
const { ccclass, property, executeInEditMode, requireComponent, menu, icon } = _decorator;
